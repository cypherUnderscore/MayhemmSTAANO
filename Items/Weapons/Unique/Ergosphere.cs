...
{
	public class Ergosphere : ModItem
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Ergosphere");
			Tooltip.SetDefault("Supershots shoot a vortex rocket\n'You gotta move faster than light to stand still here'");
		}
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				Projectile.NewProjectile(position.X, position.Y, speedX, speedY, 616, damage / 2, 0f, player.whoAmI); //weapon exclusive super effect
			...
			{
				int num2 = Dust.NewDust(position, 0, 0, 229, 0, 0, 0, default(Color), 1f);
